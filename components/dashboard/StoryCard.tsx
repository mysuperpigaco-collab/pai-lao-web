    ...
    >
      ...
      <div style={{ position: "relative", height: "170px", overflow: "hidden", background: "#f1f5f9", flexShrink: 0 }}>
        ...
        <span style={{
          ...
          background: published ? "#dcfce7" : story.approvalStatus === "REJECTED" ? "#fef2f2" : "#eff6ff",
          color:      published ? "#15803d" : story.approvalStatus === "REJECTED" ? "#b91c1c" : "#1d4ed8",
          backdropFilter: "blur(4px)",
        }}>
          <span style={{ width: "6px", height: "6px", borderRadius: "50%", background: published ? "#22c55e" : story.approvalStatus === "REJECTED" ? "#ef4444" : "#3b82f6", flexShrink: 0 }} />
          {published ? "เผยแพร่แล้ว · Published" : story.approvalStatus === "REJECTED" ? "ถูกปฏิเสธ · Rejected" : "รออนุมัติ · Pending"}
        </span>
      </div>
